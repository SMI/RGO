...
public class RGO_Column_TemplateController : Controller
{
    ...
    public IActionResult Index(int? parentId)
    {
        ...
        {
            objRGO_Column_TemplateList = _unitOfWork.RGO_Column_Template
    ...
    public IActionResult Upsert(int? id)
    {
        ...
        rgo_column_templateVM.RGO_Column_Template =
            _unitOfWork.RGO_Column_Template.FirstOrDefault(m => m.Id == id, "RGO_Dataset_Template,RGO_Release_Status");
        return View(rgo_column_templateVM);
    }
    ...
    {
        List<RGO_Column_Template> objRGO_Column_TemplateList;
        objRGO_Column_TemplateList =
            _unitOfWork.RGO_Column_Template.GetAll(includeProperties: "RGO_Dataset_Template").ToList();
        return Json(new { data = objRGO_Column_TemplateList });
    }
    ...
    public IActionResult GetAll(int? parentId)
    {
        ...
        {
            objRGO_Column_TemplateList = _unitOfWork.RGO_Column_Template
                .GetAll(includeProperties: "RGO_Dataset_Template").ToList();
            return Json(new { data = objRGO_Column_TemplateList });
        }

        objRGO_Column_TemplateList = _unitOfWork.RGO_Column_Template
            .GetAll(r => r.RGO_Dataset_TemplateId == parentId, "RGO_Dataset_Template").ToList();
        return Json(new { data = objRGO_Column_TemplateList });
    }
    ...
    public IActionResult Delete(int? id)
    {
        ...
        catch (DbUpdateException)
        {
            return Json(new
            {
                success = false,
                message =
                    "This RGO_Column_Template cannot be deleted as there are RG_Column or RGO_Record_Person records " +
